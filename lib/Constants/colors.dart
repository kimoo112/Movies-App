...
const cwhitee = Color(0xFFC0BDBF);
const cbrown=  Color(0xFF884329);
...
const credd = Color(0xFFBE0000);
const creddd = Color(0xFFFF1E00);
const clightblue = Color(0xFF6ECFF6);
const clemon = Color(0xFFFEDD00);
const cpink = Color(0xFFEF82AD);
